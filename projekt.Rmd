...
Sestavil sem tudi novo tabelo **rast_porabe**, ki vsebuje podatke o letnih spremembah v energetski porabi v Evropski Uniji. Tabela ima naslednje stolpce:
...
kable(head(rast_porabe), caption = "Rast porabe ")
```
...
```{r rast_01_15, echo=FALSE,fig.align='center',fig.width=10}
